...
<meta http-equiv="content-type" content="text/html; charset=utf-8" />  <meta http-equiv="X-UA-Compatible" content="IE=edge">
  <title>Slaptažodžio atstatymas » Kukudra</title>
...
<div class="login-box">
  ...
  <div class="login-box-body">
    <p class="login-box-msg">Slaptažodžio atstatymas</p>

    <?php echo $this->fetch('content'); ?>  
	<br><?php echo $this->Flash->render(); ?>
	  <br><br><a href="/user/login" class="text-center"><i class="fa fa-sign-out"></i> Grįžti</a>
  </div>
  <!-- /.login-box-body -->
</div>
<!-- /.login-box -->
