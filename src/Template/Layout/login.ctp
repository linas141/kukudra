...
<meta http-equiv="content-type" content="text/html; charset=utf-8" />  <meta http-equiv="X-UA-Compatible" content="IE=edge">
  <title>Vartotojo prisijungimas » Kukudra</title>
...
<div class="login-box">
  ...
  <div class="login-box-body">
    <p class="login-box-msg">Prisijunkite prie naudotojo</p>

    <?php echo $this->fetch('content'); ?>
    <?php echo $this->Flash->render(); ?>


      <a href="/user/forgotpassword">Pamiršau slaptažodį</a><br>
      Neturite naudotojo?<a href="/user/register" class="text-center"> Užsiregistruokite</a>
	  <br><br><a href="/" class="text-center"><i class="fa fa-sign-out"></i> Grįžti į puslapį</a>
  </div>
  <!-- /.login-box-body -->
</div>
<!-- /.login-box -->
