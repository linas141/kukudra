 ...
 */(function(factory){
      ...
      var localDate = this._utc_to_local(this.viewDate);
		...
		fill: function(){
			var d = new Date(this.viewDate),
				...
				todaytxt = dates[this.o.language].today || dates['lt'].today || '',
				cleartxt = dates[this.o.language].clear || dates['lt'].clear || '',
				titleFormat = dates[this.o.language].titleFormat || dates['lt'].titleFormat,
				tooltip,
				before;
        ...
        nextMonth.setUTCFullYear(prevMonth.getUTCFullYear());
			...
			var monthsTitle = dates[this.o.language].monthsTitle || dates['lt'].monthsTitle || 'Months';
	...
	var dates = $.fn.datepicker.dates = {
		...
		lt: {
		days: ['sekmadienis','pirmadienis','antradienis','trečiadienis','ketvirtadienis','penktadienis','šeštadienis'],
